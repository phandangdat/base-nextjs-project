...
import styles from '@/pages/donate/donate-monthly/index.module.css';
import ContentCopyIcon from '@mui/icons-material/ContentCopy';
import EmailIcon from '@mui/icons-material/Email';
import HomeIcon from '@mui/icons-material/Home';
import LocalPhoneIcon from '@mui/icons-material/LocalPhone';
import PersonIcon from '@mui/icons-material/Person';
import { FormControl, List, Table, TableBody, TableCell, TableContainer, TableRow, Typography } from '@mui/material';
...
export default function DonateOnce() {
  const {
    ...
    defaultValues: {
      timeDonate: '1 time',
      moneyDonateMonth: '2000',
      inputMoneyDonateMonth: '',
      moneyDonateOnce: '2000',
      inputMoneyDonateOnce: '',
      methodDonate: '',
      emailLogin: '',
      passwordLogin: '',
      name: '',
      ...
      >
        ...
        >
          ...
          >
            ...
            <Box sx={{ gridArea: 'select1', display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
              <BaseRadioGroup
                name='timeDonate'
                control={control}
                row
                sx={{ flexDirection: 'column' }}
                choices={[{ label: '毎月定額を募金します', value: '1 month' }]}
              />
              <BaseSelect
                name='moneyDonateMonth'
                control={control}
                sx={{ maxWidth: '185px' }}
                disabled={watch('timeDonate') === '1 time'}
                options={[
            ...
            <Box sx={{ gridArea: 'input1', display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
              <Typography component='p' variant='subtitle1'>
                左の選択肢以外
              </Typography>
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <BaseInput
                  name='inputMoneyDonateMonth'
                  control={control}
                  sx={{ mr: 1 }}
                  id='inputMoneyDonateMonth'
                  disabled={watch('moneyDonateMonth') !== '0' || watch('timeDonate') === '1 time'}
                  error={errors.inputMoneyDonateMonth ? true : false}
                  helperText={errors.inputMoneyDonateMonth?.message}
                />
            ...
            <Box sx={{ gridArea: 'select2', display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
              <BaseRadioGroup
                name='timeDonate'
                control={control}
                row
                sx={{ flexDirection: 'column' }}
                choices={[{ label: '今回(1回)募金します', value: '1 time' }]}
              />
              <BaseSelect
                name='moneyDonateOnce'
                control={control}
                sx={{ maxWidth: '185px' }}
                disabled={watch('timeDonate') === '1 month'}
                options={[
                  { label: '2,000円', value: '2000' },
                  { label: '3,000円', value: '3000' },
                  { label: '4,000円', value: '4000' },
            ...
            <Box sx={{ gridArea: 'input2', display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
              <Typography component='p' variant='subtitle1'>
                左の選択肢以外
              </Typography>
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <BaseInput
                  name='inputMoneyDonateOnce'
                  control={control}
                  sx={{ mr: 1 }}
                  id='inputMoneyDonateOnce'
                  disabled={watch('moneyDonateOnce') !== '0' || watch('timeDonate') === '1 month'}
                  error={errors.inputMoneyDonateOnce ? true : false}
                  helperText={errors.inputMoneyDonateOnce?.message}
                />
                <Typography component='span' variant='subtitle1'>
                  円
                </Typography>
          ...
          >
            ...
            >
              ...
              >
                ...
                <Link href='/forgot-password' rel='noreferrer' className={styles['link-forgot-password']}>
                  <ContentCopyIcon />
